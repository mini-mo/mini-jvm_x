...
public class Javap {
  ...
  public static void main(String[] args) throws IOException {
    ...
    }
    {
      ...
      var sc = String.format("  %-40s", "super_class: ".concat("#").concat(String.format("%d", cf.superClass)))
    ...
    // cp
    {
      ...
      for (int i = 1; i < cp.length; i++) {
        var ci = cp[i];
        var h = "  ".concat(String.format("%".concat(bif).concat("s"), String.format("#%d", i))).concat(" = ");
        switch (ci.tag) {
